...
REM
REM Generated by Vivado on Mon Aug 11 19:28:27 -0700 2025
...
echo "xvlog --incr --relax -prj PI_controller_testbench_vlog.prj"
call xvlog  --incr --relax -prj PI_controller_testbench_vlog.prj -log xvlog.log
